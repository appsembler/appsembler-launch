...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.trial_duration'
        db.add_column(u'deployment_project', 'trial_duration',
                      self.gf('django.db.models.fields.IntegerField')(default=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.trial_duration'
        db.delete_column(u'deployment_project', 'trial_duration')
