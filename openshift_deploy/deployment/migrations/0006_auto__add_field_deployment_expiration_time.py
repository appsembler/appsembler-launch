...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deployment.expiration_time'
        db.add_column(u'deployment_deployment', 'expiration_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deployment.expiration_time'
        db.delete_column(u'deployment_deployment', 'expiration_time')
