...
DATABASES = {
    'default': {
        ...
        'NAME': root('openshift.sqlite'),  # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'openshift_deploy.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'openshift_deploy.wsgi.application'
